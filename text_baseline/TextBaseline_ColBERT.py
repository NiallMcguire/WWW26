#!/usr/bin/env python3
"""
ColBERT v2 Text Retrieval Baseline for Brain Passage Retrieval - Pooled Documents
Evaluates ColBERT v2 with pooled documents from all datasets
...
def evaluate_colbert_ranking(colbert_retriever: ColBERTv2Retriever, queries: List[str],
    ...
    for query_idx, query_text in enumerate(tqdm(queries, desc="ColBERT ranking")):
...
def initialize_wandb(config: Dict):
    ...
    run_name = f"text_baseline_colbert_pooled{split_suffix}_{dataset_name}"
    ...
    wandb.init(
        ...
        name=run_name,
        config={
            'experiment_type': 'text_retrieval_baseline_colbert_pooled',
...
def main():
    parser = argparse.ArgumentParser(description='ColBERT v2 Text Retrieval Baseline - Pooled Documents')
    ...
    try:
        ...
        print("\n" + "=" * 80)
        print("COLBERT V2 TEXT RETRIEVAL BASELINE - POOLED DOCUMENTS")
        print("=" * 80)
        ...
        for masking_level in args.test_masking_levels:
            ...
            print(f"Encoding {len(doc_list)} pooled documents with ColBERT v2...")

            colbert_metrics, per_dataset_metrics = evaluate_colbert_ranking(
                colbert_retriever, queries, doc_list, query_to_doc_mapping,
                query_subsets, query_dataset_labels
            )

            prefix = f'text_baseline/colbert/pooled/masking_{masking_level}'
            ...
            for ds_name, ds_metrics in per_dataset_metrics.items():
                ds_prefix = f'text_baseline/colbert/{ds_name}/masking_{masking_level}'
            ...
            level_results = {**colbert_aggregated, **per_dataset_aggregated, **metadata}
            ...
            if colbert_metrics:
                ...
                hit20 = np.mean([m['hit_at_20'] for m in colbert_metrics])
                p1 = np.mean([m['precision_at_1'] for m in colbert_metrics])
                p5 = np.mean([m['precision_at_5'] for m in colbert_metrics])
                p20 = np.mean([m['precision_at_20'] for m in colbert_metrics])
                avg_rank = np.mean([m['rank_of_correct'] for m in colbert_metrics])
        ...
        if all_results:
            ...
            print(f"\n{'=' * 80}")
            print("COLBERT V2 BASELINE SUMMARY - POOLED DOCUMENTS")
            print(f"{'=' * 80}")
            ...
            for masking_level in args.test_masking_levels:
                mrr_key = f'text_baseline/colbert/pooled/masking_{masking_level}/rr'
                docs_key = f'text_baseline/colbert/pooled/masking_{masking_level}/num_unique_docs'
                rank_key = f'text_baseline/colbert/pooled/masking_{masking_level}/rank_of_correct'

                if mrr_key in all_results:
                    mrr = all_results[mrr_key]
                    hit1 = all_results[f'text_baseline/colbert/pooled/masking_{masking_level}/hit_at_1']
                    hit5 = all_results[f'text_baseline/colbert/pooled/masking_{masking_level}/hit_at_5']
                    hit10 = all_results[f'text_baseline/colbert/pooled/masking_{masking_level}/hit_at_10']
                    hit20 = all_results[f'text_baseline/colbert/pooled/masking_{masking_level}/hit_at_20']
                    p1 = all_results[f'text_baseline/colbert/pooled/masking_{masking_level}/precision_at_1']
                    p5 = all_results[f'text_baseline/colbert/pooled/masking_{masking_level}/precision_at_5']
                    p20 = all_results[f'text_baseline/colbert/pooled/masking_{masking_level}/precision_at_20']
            ...
            for ds in sorted(datasets_found):
                ...
                for masking_level in args.test_masking_levels:
                    ...
                    if mrr_key in all_results:
                        ...
                        ds_h1_vals.append(all_results[f'text_baseline/colbert/{ds}/masking_{masking_level}/hit_at_1'])
                        ds_h5_vals.append(all_results[f'text_baseline/colbert/{ds}/masking_{masking_level}/hit_at_5'])
                        ds_h10_vals.append(all_results[f'text_baseline/colbert/{ds}/masking_{masking_level}/hit_at_10'])
                        ds_h20_vals.append(all_results[f'text_baseline/colbert/{ds}/masking_{masking_level}/hit_at_20'])
            ...
            # Now print the detailed per-masking-level breakdowns for each dataset
            for ds in sorted(datasets_found):
                ...
                for masking_level in args.test_masking_levels:
                    mrr_key = f'text_baseline/colbert/{ds}/masking_{masking_level}/rr'
                    rank_key = f'text_baseline/colbert/{ds}/masking_{masking_level}/rank_of_correct'
                    ...
                    if mrr_key in all_results:
                        ...
                        hit20 = all_results[f'text_baseline/colbert/{ds}/masking_{masking_level}/hit_at_20']
                        p1 = all_results[f'text_baseline/colbert/{ds}/masking_{masking_level}/precision_at_1']
                        p5 = all_results[f'text_baseline/colbert/{ds}/masking_{masking_level}/precision_at_5']
                        p20 = all_results[f'text_baseline/colbert/{ds}/masking_{masking_level}/precision_at_20']
                        rank = all_results.get(rank_key, 0)
        ...
        wandb.finish()
        print(f"\n{'=' * 80}")
        print("COLBERT V2 POOLED BASELINE EVALUATION COMPLETE")
        print(f"{'=' * 80}")
